...
import com.csv.upload.config.audit.AuditEventConverter;
import com.csv.upload.domain.PersistentAuditEvent;
...
import static com.csv.upload.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
